...
},{"./lib/axios":"node_modules/axios/lib/axios.js"}],"js/feed.js":[function(require,module,exports) {
"use strict";
  ...
  _insert = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3() {
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        case 0:
          _context3.next = 2;
          return _axios.default.post(url + 'feed', {
  ...
  _clear = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4() {
    return _regeneratorRuntime().wrap(function _callee4$(_context4) {
      while (1) switch (_context4.prev = _context4.next) {
        case 0:
          $("#artigoBem").val(""), $("#artigoProd").val(""), $("#conquistaUsuario").val(""), $("#conquistaAmigo").val(""), refreshtable();
        case 1:
        case "end":
...
function loadTable() {
  _axios.default.get(url + 'feed', {}).then(function (response) {
...
function _loadFeed() {
  _loadFeed = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee6(id) {
    return _regeneratorRuntime().wrap(function _callee6$(_context6) {
      while (1) switch (_context6.prev = _context6.next) {
        case 0:
          _context6.next = 2;
          return _axios.default.get(url + 'feed/' + id, {}).then(function (response) {
...
function _deleteRecord() {
  _deleteRecord = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee7(id) {
    return _regeneratorRuntime().wrap(function _callee7$(_context7) {
      while (1) switch (_context7.prev = _context7.next) {
        case 0:
          _context7.next = 2;
          return _axios.default.delete(url + 'feed/' + id, {}).then(function (response) {
...
function _update() {
  _update = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee8() {
    return _regeneratorRuntime().wrap(function _callee8$(_context8) {
      while (1) switch (_context8.prev = _context8.next) {
        case 0:
          _context8.next = 2;
          return _axios.default.put(url + 'feed', {
            id: $("#id").val(),
            artigoDeBemEstar: $("#artigoBem").val(),
            artigoDeProdutividade: $("#artigoProd").val(),
            conquistaUsuario: $("#conquistaUsuario").val(),
