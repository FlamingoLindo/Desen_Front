...
},{"./lib/axios":"node_modules/axios/lib/axios.js"}],"js/tabela_usuario.js":[function(require,module,exports) {
"use strict";
  ...
  _clear = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4() {
    return _regeneratorRuntime().wrap(function _callee4$(_context4) {
      while (1) switch (_context4.prev = _context4.next) {
        case 0:
          $("#nome").val(""), $("#sobrenome").val(""), $("#email").val(""), $("#admin").prop('checked', false), $("#senha").val(""), $("#dataNascimento").val(""), $("#selectP").val("");
          refreshtable();
        case 2:
        case "end":
        ...
        case 0:
          _axios.default.get(url + 'profiles', {}).then(function (response) {
            ...
            $.each(response.data, function (key, item) {
              $('#selectP').append($("<option></option>").attr("value", item.id).text(item.nome));
            });
          }).catch(function (error) {
            alert(error);
          });
...
function _loadUser() {
  _loadUser = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee8(id) {
...
},{}]},{},["node_modules/parcel-bundler/src/builtins/hmr-runtime.js","js/tabela_usuario.js"], null)
//# sourceMappingURL=/tabela_usuario.a3b5a0cf.js.map